...
var (
	...
	cpuProfile       = flag.String("cpuprofile", "", "write a goroutine blocking profile to the named file after execution")
...
func startCPUProfile() {
	if *cpuProfile != "" {
		...
		if err != nil {
			fmt.Fprintf(os.Stderr, "Coudn't create cpu profile output file: %s\n", err)
			return
		}
